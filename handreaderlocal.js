...
const { clientId, guildId, token, user, password, host, database, port, adminRole, supportChannelID, roles, userTable } = require('./configLocal.json');
...
const coachRolesID = ['932666956958531654']; //Local
//Spins > Cash > MTT
...
//const canalesManos = ['655925523242942474'];
const canalesManos = ['932967261940117504']; //Local
